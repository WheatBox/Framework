...
namespace Frame {
	...
	public:
		...
		void DrawSprite(const SSpriteImage * pSpriteImage, const Vec2 & vPos, const Vec2 & vScale, float rotation, STextureVertexBuffer && textureVertexBuffer) {
			DrawSprite(pSpriteImage, vPos, vScale, rotation, static_cast<STextureVertexBuffer &>(textureVertexBuffer));
		}

		void DrawSprite(const SSpriteImage * pSpriteImage, const Vec2 & vPos) {
			DrawSprite(pSpriteImage, vPos, m_defaultTextureVertexBuffer);
		}
		void DrawSprite(const SSpriteImage * pSpriteImage, const Vec2 & vPos, const Vec2 & vScale, float rotation) {
			DrawSprite(pSpriteImage, vPos, vScale, rotation, m_defaultTextureVertexBuffer);
		}
		...
		void DrawSpriteColorBlended(const SSpriteImage * pSpriteImage, const Vec2 & vPos, const ColorRGB & rgb, const Vec2 & vScale, float rotation) {
			STextureVertexBuffer textureVertexBuffer = m_defaultTextureVertexBuffer;
			textureVertexBuffer.SetColorBlends(rgb);
			DrawSprite(pSpriteImage, vPos, vScale, rotation, textureVertexBuffer);
		}
		...
		void DrawSpriteColorBlended(const SSpriteImage * pSpriteImage, const Vec2 & vPos,
			const ColorRGB & rgbTL,    const ColorRGB & rgbTR,
			const ColorRGB & rgbBL,    const ColorRGB & rgbBR,
			const Vec2 & vScale, float rotation
		) {
			STextureVertexBuffer textureVertexBuffer = m_defaultTextureVertexBuffer;
			textureVertexBuffer.SetColorBlends(rgbTL, rgbTR, rgbBL, rgbBR);
			DrawSprite(pSpriteImage, vPos, vScale, rotation, textureVertexBuffer);
		...
		void DrawSpriteAlphaBlended(const SSpriteImage * pSpriteImage, const Vec2 & vPos, float alpha, const Vec2 & vScale, float rotation) {
			STextureVertexBuffer textureVertexBuffer = m_defaultTextureVertexBuffer;
			textureVertexBuffer.SetAlphaBlends(alpha);
			DrawSprite(pSpriteImage, vPos, vScale, rotation, textureVertexBuffer);
		}
		...
		void DrawSpriteBlended(const SSpriteImage * pSpriteImage, const Vec2 & vPos, const ColorRGB & rgb, float alpha, const Vec2 & vScale, float rotation) {
			DrawSprite(pSpriteImage, vPos, vScale, rotation, { {}, {},
				rgb, alpha, rgb, alpha, rgb, alpha, rgb, alpha
			});
		}
